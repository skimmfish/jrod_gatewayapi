...
return [
     ...
     */
    'title' => 'Gatewayblvd Documentation',

    /*
     * A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
     */
    'description' => 'This documentation highlights all endpoints needed to integrate backend services with the skyline modem',

    /*
     * The base URL displayed in the docs. If this is empty, Scribe will use the value of config('app.url') at generation time.
     * If you're using `laravel` type, you can set this to a dynamic string, like '{{ config("app.tenant_url") }}' to get a dynamic base URL.
     */
    'base_url' => 'https://gatewayblvd.net/app/en/api/',
    ...
    'try_it_out' => [
         ...
         * '/login' endpoint uses https://gatewayblvd.net/app/en/api/login endpoint with the body params to get an authentication token while other endpoints uses
         * https://gatewayblvd.net/app/en/api/v1 base URL.
         */
        'base_url' => null,
    ...
    'auth' => [
         ...
         */
        'extra_info' => "You can retrieve your token by using the 'auth_token' object in the json_decode object returned in the response body dashboard and clicking <b>Generate API token</b>.",
    ],
